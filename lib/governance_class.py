...
class GovernanceClass(object):
    ...
    def list(self):
        ...
        # return a dict similar to graviumd "gobject list" output
    ...
    def graviumd_serialise(self):
        import graviumlib
        return graviumlib.SHIM_serialise_for_graviumd(self.serialise())
