...
class GovernanceClass(object):
    ...
    def list(self):
        ...
        # return a dict similar to hiluxd "gobject list" output
    ...
    def hiluxd_serialise(self):
        import hiluxlib
        return hiluxlib.SHIM_serialise_for_hiluxd(self.serialise())
